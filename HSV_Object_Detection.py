...
camera.set(cv2.CAP_PROP_FPS,26)		#Frame rate
camera.set(3,240)						#3 = Width of the frames in the video
camera.set(4,320)						#4 = Height of the frames  in the video
...
while(1):
    ...
    red = cv2.erode(red, kernal, iterations = 3)
    red = cv2.dilate(red, kernal, iterations = 6)
